...
public class PersonOverviewController {
    ...
    private void initialize() {
        ...
        deleteButton.disableProperty().bind(personTable.getSelectionModel().selectedItemProperty().isNull());
        editButton.disableProperty().bind(personTable.getSelectionModel().selectedItemProperty().isNull());
    }
